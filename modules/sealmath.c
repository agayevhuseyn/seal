...
seal_value __seal_math_sqrt(seal_byte argc, seal_value *argv)
{
  ...
  seal_value num;
  seal_parse_args(MOD_NAME, FUNC_NAME, argc, argv, 1, PARAM_TYPES(SEAL_NUMBER), &num);
...
seal_value __seal_math_pow(seal_byte argc, seal_value *argv)
{
  ...
  seal_value base, exp;
  seal_parse_args(MOD_NAME, FUNC_NAME, argc, argv, 2, PARAM_TYPES(SEAL_NUMBER, SEAL_NUMBER), &base, &exp);
...
seal_value __seal_math_sin(seal_byte argc, seal_value *argv)
{
  ...
  seal_value rad;
  seal_parse_args(MOD_NAME, FUNC_NAME, argc, argv, 1, PARAM_TYPES(SEAL_NUMBER), &rad);
...
seal_value __seal_math_asin(seal_byte argc, seal_value *argv)
{
  ...
  seal_value val;
  seal_parse_args(MOD_NAME, FUNC_NAME, argc, argv, 1, PARAM_TYPES(SEAL_NUMBER), &val);
...
seal_value __seal_math_atan2(seal_byte argc, seal_value *argv)
{
  ...
  seal_value y, x;
  seal_parse_args(MOD_NAME, FUNC_NAME, argc, argv, 2, PARAM_TYPES(SEAL_NUMBER, SEAL_NUMBER), &y, &x);
