...
typedef enum {
  // ids
  TOK_VAR, TOK_ID, TOK_OBJECT, TOK_DEFINE, TOK_INCLUDE, TOK_AS,
  // parens
  ...
  // misc
  TOK_DOT, TOK_COMMA, TOK_COLON, TOK_DCOLON, TOK_IN, TOK_QUESTION,
  // blocks
  TOK_NEWL, TOK_INDENT, TOK_DEDENT, TOK_SEMI, TOK_IF, TOK_THEN, TOK_ELSE, TOK_WHILE, TOK_FOR,
  // flow op
